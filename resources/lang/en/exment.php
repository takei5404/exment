...
return [
    ...
    'system' => [
        ...
        'chatbot_faq_wf' => 'Use workflow for creating FAQ',
        'chatbot_faq_wf_status_filters' => 'Filter by Workflow Status',
        'chatbot_faq_wf_status_filters_default' => 'Approved',
        'chatbot_timeidle' => 'Chatbot wait time (minutes)',
        ...
        'help' =>[
            ...
            'ai_assistant_available' => 'Set to YES to enable AI Assistant features.',
            'ai_ocr_available' => 'Set to YES to enable AI OCR features.',
            'chatbot_available' => 'Display the chat box and the chatbot will automatically respond to your questions.',
            'chatbot_faq_wf' => 'When set to YES, you can create a FAQ using the workflow. If you do not use the workflow, set this to NO.',
            'chatbot_faq_wf_status_filters' => 'Enter the workflow statuses of the FAQ that you want the chatbot to filter and display. Use a new line to separate each status',
            'chatbot_timeidle' => 'Set the wait time before the chatbot checks if the user needs more help',
    ...
    'plugin' => [
        ...
        'status' => [
            ...
            'installed'      => 'Installed',
            'disabled'       => 'Disabled',
            'market_deleted' => 'Removed from Market',
            'version_deleted'=> 'Installed Version Removed',
        ],
        'market' => [
            'title' => 'Plugin Market',
            ...
            'version_modal' => [
                ...
                'failed_load' => 'Failed to load versions',
                'changelog' => 'Changelog',
                'cancel' => 'Cancel',
                'install' => 'Install Plugin',
                'latest' => 'Latest',
            ...
            'detail' => [
                ...
                'plugin_id' => 'Plugin ID',
                'plugin_name' => 'Plugin Name',
                'plugin_view_name' => 'Plugin Display Name',
                'plugin_type' => 'Plugin Type',
                'author' => 'Author',
                'created_user' => 'Created User',
                'version' => 'Version',
            ...
            'message' => [
                ...
                'uninstall_confirm_text' => 'This action cannot be undone.',
                'uninstall_success' => 'Plugin ":name" uninstalled successfully!',
                'installing' => 'Installing...',
                'uninstalling' => 'Uninstalling...',
                'expired_warning' => 'Expired',
                'payment_processing' => 'Processing...',
                'renew_processing' => 'Processing...',
                'payment_failed' => 'Payment failed.',
                'notice_title' => 'Notice',
                'ok' => 'OK',
                'manual_payment_required' => 'Automatic payment and automatic installation are available only for paid Exment accounts. You can still proceed on the Plugin Market to complete payment and install manually.',
                'missing_tenant_uuid' => 'Missing tenant_uuid.',
                ...
                'please_enter_license' => 'Please enter the license key',
                'please_select_version' => 'Please select a version',
                'install_failed' => 'Installation failed',
                'uninstall_failed' => 'Uninstallation failed',
                'error_occurred' => 'An error occurred while processing the plugin',
                'no_versions' => 'No versions available',
                'version_load_failed' => 'Failed to load versions',
            ],
        ],
        'options' => [
    ...
    'custom_table' => [
        ...
        'include_view_flg' => 'Include custom view',
        'include_form_flg' => 'Include custom form',
        ...
        'help' => [
            ...
            'ai_ocr_import_multi_alert' => 'Import File has multiple results. Please use Import Multi feature for this file',
            ...
            'copy_custom_table' => 'Copy normal settings, advanced settings and custom columns.<br />Optionally, you can also copy custom views and custom forms.<br />Other settings are out of scope. Please set manually.',
            'include_view_flg' => 'Relations and workflows are not copied, so views associated with them are not included, and user views are not included either.',
            'include_form_flg' => 'Form priority settings and public forms are not copied. Also, child table blocks are not included.',
    ...
    'custom_column' => [
        ...
        'options' => [
            ...
            'ocr_default_value' => 'OCR Default Value',
        ...
        'help' => [
            ...
            'ocr_default_value' => 'When using OCR, it may not find any results. So if it is a required field, please enter the default value here. Used when OCR does not have any results.',
    ...
    'tenant' => [
        ...
        'env_vars_help' => 'One KEY=VALUE per line. Sensitive keys (credentials, storage paths, security settings) are blocked and will not be saved.',
        'language' => 'Language',
        'timezone' => 'Time Zone',
        ...
        'faq_validate' => 'FAQ must be a clear question with search value.',
    ],
    ...
    'ai_assistant' => [
        ...
        'welcome_message' => 'I would be happy to assist you in creating a new :type. Please send me a request.',
